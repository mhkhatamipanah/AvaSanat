    ...
    return (
        <>
            <div className="flex gap-4 items-center">
                {load && countData ? 
                <Badge style={{ border: "1px solid #fe6d67", backgroundColor: "#ffc5cb", color: "black", paddingTop: "3px" }} content={load ? countData : 0} size="lg" color="warning">
                    <Link href={"/invoice"} className='text-md bg-[var(--color-1)] text-white rounded-md w-max px-4 h-[40px] flex items-center justify-center gap-1' variant="shadow">
                        <ShoppingBag size={width > 768 ? 28 : width > 400 ? 22 : 20} />
                        <p className="text-[14px] !block max-[768px]:!hidden">
                            پیش فاکتور
                        </p>
                    </Link>
                </Badge> 
