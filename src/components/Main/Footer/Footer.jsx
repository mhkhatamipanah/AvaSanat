      ...
      {(!pathname.includes("/dashboard") && pathname !== "/login") &&
        <>
          ...
          <footer className='relative min-h-[350px] flex flex-col items-center justify-center w-full mt-4'>
            <Wave />
            <div className=' grid grid-cols-6 vazirMedium h-full items-start p-5 gap-6 max-w-[1500px] px-3 sm:px-6 z-50'>

              <div className='col-span-6 min-[1200px]:col-span-3 flex flex-col p-3 sm:p-5 justify-center max-[600px]:items-center gap-4'>

                <Image className="object-contain h-10 w-min ml-3 " src={logo} alt="logo" />

                <p className='text-gray-700 max-sm:text-center'>
              ...
              <div className='col-span-6 min-[600px]:col-span-2 min-[1200px]:col-span-1 flex p-3 sm:p-5 flex-col justify-center max-[600px]:items-center gap-4'>
            ...
            <span className="block text-sm text-gray-600 sm:text-center px-3 my-5 vazirMedium z-30">
