...
const Wave = () => {
    return (
        <div className='w-full absolute bottom-0  rotate-180'>
            <svg className='text-gray-300' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 27.8" preserveAspectRatio="none">
