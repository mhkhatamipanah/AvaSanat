            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="username" type="text" required className="w-full text-sm border border-gray-300 border-solid px-4 py-3 rounded-md outline-[#333] enFont tracking-wide" placeholder="Enter user name" />
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="password" type={`${showPassword ? "text" : "password" }`} required className="w-full text-sm border border-gray-300 border-solid px-4 py-3 rounded-md outline-[#333] enFont tracking-wide" placeholder="Enter password" />
                  <svg onClick={()=>{
              ...
              <div className="!mt-10">
                <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-[#333] hover:bg-gray-900 focus:outline-none vazirMedium">
                 ورود
                </button>
              </div>
